...
const voteFromEmail = asyncHandler(async (req, res) => {
  try {
    ...
    const alreadyVoted = report.verifiedBy.some(
...
const addVote = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, updateReport, "Vote added successfully"));
  } catch (error) {
...
const joinReport = asyncHandler(async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, report, "Report joined successfully."));
  } catch (error) {
